...
const (
	...
	BrSendTypeLiquidity     = uint8(1)
	BrSendTypePegDeposit    = uint8(2)
	BrSendTypePegBurn       = uint8(3)
	BrSendTypePegV2Deposit  = uint8(4)
	BrSendTypePegV2Burn     = uint8(5)
	BrSendTypePegV2BurnFrom = uint8(6)
)
