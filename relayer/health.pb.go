...
type SgnAnalyticsReport struct {
	...
	ChainConfigs map[string]*ChainConfig `protobuf:"bytes,6,rep,name=ChainConfigs,proto3" json:"ChainConfigs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var fileDescriptor_d6fdaa49c355133b = []byte{
	...
	,
}
