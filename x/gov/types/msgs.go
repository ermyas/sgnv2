...
//nolint:interfacer
func NewMsgSubmitProposal(content Content, initialDeposit sdk.Int, proposer sdk.AccAddress) (*MsgSubmitProposal, error) {
	m := &MsgSubmitProposal{
...
func (m *MsgSubmitProposal) GetInitialDeposit() sdk.Int { return m.InitialDeposit }
...
func (m *MsgSubmitProposal) SetInitialDeposit(coins sdk.Int) {
...
func (m MsgSubmitProposal) ValidateBasic() error {
	...
	if m.InitialDeposit.IsNegative() {
