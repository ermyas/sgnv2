...
type Transfer struct {
	...
	RefId []byte `protobuf:"bytes,4,opt,name=ref_id,json=refId,proto3" json:"ref_id,omitempty" yaml:"ref_id"`
}
...
type ExecutionContext struct {
	...
	Powers []string `protobuf:"bytes,4,rep,name=powers,proto3" json:"powers,omitempty" yaml:"powers"`
}
...
func (m *ExecutionContext) GetPowers() []string {
	if m != nil {
		return m.Powers
	}
	return nil
...
var fileDescriptor_1199d6c48a0ec756 = []byte{
	...
	,
}
...
func (m *Transfer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RefId) > 0 {
		i -= len(m.RefId)
		copy(dAtA[i:], m.RefId)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.RefId)))
		i--
		dAtA[i] = 0x22
	}
	if m.SeqNum != 0 {
...
func (m *ExecutionContext) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Powers) > 0 {
		for iNdEx := len(m.Powers) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintMessage(dAtA, i, uint64(len(m.Powers[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
