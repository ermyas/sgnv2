...
type ChainAsset struct {
	...
	MaxAmt       github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,6,opt,name=max_amt,json=maxAmt,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"max_amt"`
}
...
var fileDescriptor_ea88343271b63cf0 = []byte{
	...
	,
}
...
func (m *ChainAsset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.MaxAmt.Size()
		i -= size
		if _, err := m.MaxAmt.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintCbridge(dAtA, i, uint64(size))
	}
...
func (m *ChainAsset) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := m.MaxAmt.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
