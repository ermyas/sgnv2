...
type LiqStatus int32

const (
	LiqStatus_LIQ_UNKNOWN LiqStatus = 0
	// user for withdraw: after calling withdraw api
	// relayer for add: monitored add event
	LiqStatus_LIQ_WAITING_FOR_SGN LiqStatus = 1
	LiqStatus_LIQ_WAITING_FOR_LP  LiqStatus = 2
	LiqStatus_LIQ_SUBMITTING      LiqStatus = 3
	LiqStatus_LIQ_COMPLETED       LiqStatus = 4
	// user for add: check if tx reverted when shown status is LIQ_SUBMITTING
	// x for withdraw: sgn rejected
	LiqStatus_LIQ_FAILED LiqStatus = 5
)

var LiqStatus_name = map[int32]string{
	0: "LIQ_UNKNOWN",
	1: "LIQ_WAITING_FOR_SGN",
	2: "LIQ_WAITING_FOR_LP",
	3: "LIQ_SUBMITTING",
	4: "LIQ_COMPLETED",
	5: "LIQ_FAILED",
}

var LiqStatus_value = map[string]int32{
	"LIQ_UNKNOWN":         0,
	"LIQ_WAITING_FOR_SGN": 1,
	"LIQ_WAITING_FOR_LP":  2,
	"LIQ_SUBMITTING":      3,
	"LIQ_COMPLETED":       4,
	"LIQ_FAILED":          5,
}

func (x LiqStatus) String() string {
	return proto.EnumName(LiqStatus_name, int32(x))
}

func (LiqStatus) EnumDescriptor() ([]byte, []int) {
...
type QueryLiquidityStatusResponse struct {
	Status LiqStatus       `protobuf:"varint,1,opt,name=status,proto3,enum=sgn.cbridge.v1.LiqStatus" json:"status,omitempty"`
...
func (m *QueryLiquidityStatusResponse) GetStatus() LiqStatus {
	if m != nil {
		return m.Status
	}
	return LiqStatus_LIQ_UNKNOWN
}
...
func init() {
	proto.RegisterEnum("sgn.cbridge.v1.LiqStatus", LiqStatus_name, LiqStatus_value)
...
var fileDescriptor_5ff091f26d628673 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= LiqStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
