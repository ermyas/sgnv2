...
type QuerySupplyInfoRequest struct {
	OrigChainId   uint64 `protobuf:"varint,1,opt,name=orig_chain_id,json=origChainId,proto3" json:"orig_chain_id,omitempty"`
	PeggedChainId uint64 `protobuf:"varint,2,opt,name=pegged_chain_id,json=peggedChainId,proto3" json:"pegged_chain_id,omitempty"`
	PeggedAddress string `protobuf:"bytes,3,opt,name=pegged_address,json=peggedAddress,proto3" json:"pegged_address,omitempty"`
}
...
func (m *QuerySupplyInfoRequest) GetOrigChainId() uint64 {
	if m != nil {
		return m.OrigChainId
	}
	return 0
}
...
var fileDescriptor_26edb5787af23cdd = []byte{
	...
	,
}
...
func (m *QuerySupplyInfoRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OrigChainId != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.OrigChainId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *QuerySupplyInfoRequest) Size() (n int) {
	...
	_ = l
	if m.OrigChainId != 0 {
		n += 1 + sovQuery(uint64(m.OrigChainId))
	}
	if m.PeggedChainId != 0 {
...
func (m *QuerySupplyInfoRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrigChainId", wireType)
			}
			m.OrigChainId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OrigChainId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
