...
import (
	...
	"github.com/celer-network/sgn-v2/proto/sgn"
...
func GetQueryCmd(storeKey string, cdc *codec.Codec) *cobra.Command {
	...
	validatorQueryCmd.AddCommand(common.GetCommands(
		...
		GetCmdValidator(stakingTypes.StoreKey, cdc),
		GetCmdValidators(stakingTypes.StoreKey, cdc),
...
func QueryDelegator(cliCtx client.Context, queryRoute, candidateAddress, delegatorAddress string) (delegator types.Delegator, err error) {
...
func GetCmdCandidate(queryRoute string, cdc *codec.Codec) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cliCtx.PrintProto(candidate)
		},
	}
}

func QueryCandidate(cliCtx client.Context, queryRoute, ethAddress string) (candidate types.Candidate, err error) {
...
func QueryCandidates(cliCtx client.Context, queryRoute string) (candidates []types.Candidate, err error) {
...
func QueryCandidateDelegators(cliCtx client.Context, queryRoute, ethAddress string) (delegators []types.Delegator, err error) {
	// data, err := cliCtx.Codec.MarshalJSON(types.NewQueryCandidateParams(ethAddress))
	// if err != nil {
	// 	return
	// }
...
func QueryValidators(cliCtx client.Context, storeName string) (validators stakingTypes.Validators, err error) {
...
func QueryBondedValidators(cliCtx client.Context, storeName string) (validators stakingTypes.Validators, err error) {
...
func QueryValidator(cliCtx client.Context, storeName string, addrStr string) (validator stakingTypes.Validator, err error) {
...
func QueryRewardStats(cliCtx client.Context, queryRoute string) (stats types.RewardStats, err error) {
