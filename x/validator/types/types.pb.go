...
type Validator struct {
	...
	Status         ValidatorStatus `protobuf:"varint,3,opt,name=status,proto3,enum=ValidatorStatus" json:"status,omitempty"`
	SgnAddress     string          `protobuf:"bytes,4,opt,name=sgn_address,json=sgnAddress,proto3" json:"sgn_address,omitempty"`
	Transactors    []string        `protobuf:"bytes,5,rep,name=transactors,proto3" json:"transactors,omitempty"`
	Tokens         string          `protobuf:"bytes,6,opt,name=tokens,proto3" json:"tokens,omitempty"`
	Shares         string          `protobuf:"bytes,7,opt,name=shares,proto3" json:"shares,omitempty"`
...
func init() {
	proto.RegisterEnum("ValidatorStatus", ValidatorStatus_name, ValidatorStatus_value)
...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
