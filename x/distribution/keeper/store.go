...
func (k Keeper) GetValidatorSlashEvent(ctx sdk.Context, val eth.Addr, height, period uint64) (event types.ValidatorSlashEvent, found bool) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) SetValidatorSlashEvent(ctx sdk.Context, val eth.Addr, height, period uint64, event types.ValidatorSlashEvent) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) IterateValidatorSlashEventsBetween(ctx sdk.Context, val eth.Addr, startingHeight uint64, endingHeight uint64,
...
func (k Keeper) IterateValidatorSlashEvents(ctx sdk.Context, handler func(val eth.Addr, height uint64, event types.ValidatorSlashEvent) (stop bool)) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) DeleteValidatorSlashEvents(ctx sdk.Context, val eth.Addr) {
	store := ctx.KVStore(k.storeKey)
