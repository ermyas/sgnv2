...
func QueryDelegationRewards(clientCtx client.Context, delAddr, valAddr string) ([]byte, int64, error) {
	delegatorAddr := eth.Hex2Addr(delAddr)
	validatorAddr := eth.Hex2Addr(valAddr)
...
func QueryDelegatorValidators(clientCtx client.Context, delegatorAddr eth.Addr) ([]byte, error) {
...
func QueryValidatorCommission(clientCtx client.Context, validatorAddr eth.Addr) ([]byte, error) {
	res, _, err := clientCtx.QueryWithData(
...
func WithdrawAllDelegatorRewards(clientCtx client.Context, delegatorAddr eth.Addr) ([]sdk.Msg, error) {
...
func WithdrawValidatorRewardsAndCommission(validatorAddr eth.Addr, validatorEthAddr eth.Addr) ([]sdk.Msg, error) {
	...
	rewardMsg := types.NewMsgWithdrawDelegatorReward(validatorEthAddr, validatorAddr)
