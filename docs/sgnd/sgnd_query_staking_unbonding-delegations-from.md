## sgnd query staking unbonding-delegations-from
...
Example:
$ <appd> query staking unbonding-delegations-from sgnvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
sgnd query staking unbonding-delegations-from [validator-addr] [flags]
```
