## sgnd query staking unbonding-delegations
...
Example:
$ <appd> query staking unbonding-delegations sgn1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```
sgnd query staking unbonding-delegations [delegator-addr] [flags]
```
