## sgnd tx gov submit-proposal cbridge-change

Submit a cbridge config change proposal
...
```
sgnd tx gov submit-proposal cbridge-change [proposal-file] [flags]
```
...
```
  ...
  -h, --help                     help for cbridge-change
