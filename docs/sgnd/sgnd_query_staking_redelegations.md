## sgnd query staking redelegations
...
Example:
$ <appd> query staking redelegation sgn1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```
sgnd query staking redelegations [delegator-addr] [flags]
```
