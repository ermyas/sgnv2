## sgnd query staking delegations-to
...
Example:
$ <appd> query staking delegations-to sgnvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
sgnd query staking delegations-to [validator-addr] [flags]
```
